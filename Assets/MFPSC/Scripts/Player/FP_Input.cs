...
public class FP_Input : MonoBehaviour 
{
	...
	public bool PickUp()
	{
		return mobileInputs.pickUpButton != null ? mobileInputs.pickUpButton.OnRelease() : false;
	}
}
...
public class Inputs
{
    ...
    public FP_Button runButton, jumpButton, crouchButton, shotButton, reloadButton, pickUpButton;
}